		...
		<form method="POST">
			<table>
				...
				<tr>
					...
					<td><input type="number" name="no_question"
						placeholder="Enter Number of Question"></td>
				</tr>

				<tr>
					<td><label>Negative Marking</label></td>
					<td>
					 <input type="text" name="neg_marks" class="neg" placeholder="Enter Negative Marks"></td>
				</tr>
				<tr>
					<td><button type="submit" formaction="generate_question">Add</button></td>
					<td><button type="submit" formaction="clear_oldexam">Clear
							Database from old Exam</button></td>
				</tr>
